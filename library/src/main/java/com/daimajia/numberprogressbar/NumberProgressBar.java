...
public class NumberProgressBar extends View {
    ...
    private final int default_text_background_color = Color.rgb(66, 145, 241);
    ...
    RectF mTextBackgroundRect = new RectF(0, 0, 0, 0);
    /**
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_unreached_bar_height = dp2px(3f);
        ...
        mTextBackgroundColor = attributes.getColor(R.styleable.NumberProgressBar_progress_text_background_color, default_text_background_color);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIfDrawText) {
            canvas.drawRoundRect(new RectF(mReachedRectF.right - mDrawTextWidth / 2, 0, mReachedRectF.right + mDrawTextWidth / 2, mDrawTextHeight), mDrawTextHeight / 2, mDrawTextHeight / 2, mTextBackgroundPaint);
    ...
    private void calculateDrawRectFWithoutProgressText() {
        ...
        mReachedRectF.right = (getWidth() - getPaddingLeft() - getPaddingRight()) / (getMax() * 1.0f) * Math.min(getMax(), getProgress()) + getPaddingLeft();
        ...
        mTextBackgroundRect.left = mReachedRectF.right - mDrawTextWidth / 2;
        mTextBackgroundRect.top = 0;
        mTextBackgroundRect.right = mReachedRectF.right + mDrawTextWidth / 2;
        mTextBackgroundRect.bottom = mDrawTextHeight;
    }
